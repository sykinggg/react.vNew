...
Axios.interceptors.response.use(
    ...
    error => {
        ...
        // alert(error.message);
        console.log(PositionedSnackbar);
        // PositionedSnackbar(error.message);
...
export default {
    install: function (React: any, Option: any) {
        Object.defineProperty(React.prototype, "$http", { value: Axios });
    }
};